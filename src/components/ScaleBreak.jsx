      ...
      <div className="text-center max-w-7xl mr-auto mb-4 ml-auto">
        <h2 className="mb-6 mt-6 font-space-grotesk text-4xl font-medium tracking-tight text-kb-ink md:text-6xl">
          ...
          <span className="inline-flex align-bottom text-kb-accent-ink mx-1 relative">
            ...
            <span className="split-word-top [clip-path:polygon(0_0,100%_0,100%_50%,0_50%)] font-medium font-space-grotesk w-full h-full absolute top-0 left-0 text-kb-accent-ink">waits</span>
            ...
            <span className="split-word-bottom [clip-path:polygon(0_50%,100%_50%,100%_100%,0_100%)] font-medium text-kb-accent-ink w-full h-full absolute top-0 left-0">waits</span>
          </span>
        </h2>
        <p className="font-inter text-lg font-light text-kb-ink-soft sm:text-2xl">
          Every tool does its job. But between one and the next, someone still has to copy, check, chase, forward and follow up.
        </p>
      </div>
    </section>
  );
