...
export default function Testimonials() {
  ...
  return (
    <section className="relative border-t border-kb-line bg-kb-surface-soft pb-4 pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="fade-up-element flex flex-col sm:flex-row sm:items-end gap-6 z-40 mb-16 relative gap-x-6 gap-y-6 items-start justify-between">
          <div>
            ...
            <h2 className="mb-4 font-grotesk text-4xl font-medium tracking-tight text-kb-ink sm:text-6xl">we should talk.</h2>
            <p className="text-base font-light text-kb-ink-muted sm:text-lg">The spreadsheet is still running half the operation.</p>
          </div>
        </div>
        <div className="flex flex-col sm:gap-24 pb-[5vh] relative gap-x-12 gap-y-12">
          <div className="testimonial-sticky sticky top-24 z-10 w-full">
            <div className="testimonial-inner w-full relative z-10" style={{ filter: 'brightness(1)' }}>
              <div className="pointer-events-none absolute -left-10 -top-16 z-0 h-[300px] w-[300px] rounded-full bg-[#FE4C00] opacity-15 blur-[100px] sm:-left-20 sm:-top-24 sm:h-[500px] sm:w-[500px] sm:blur-[120px]"></div>
