      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100svh+30rem)] w-full max-w-7xl items-end justify-center px-4 pb-0 pt-40 md:min-h-[calc(100svh+17.5rem)] sm:px-8 lg:px-10">
        <div className="w-full text-center">
          ...
          <p className="mx-auto mt-7 max-w-6xl text-center font-inter text-sm font-light leading-relaxed text-kb-inverse-text/85 sm:text-base md:text-lg">
            <span className="block sm:whitespace-nowrap">Kitebaze connects the software you already pay for — scheduling, accounting, documents, email, spreadsheets —</span>
          ...
          <div className="mx-auto mt-14 w-full max-w-5xl rounded-[1.75rem] border border-white/25 bg-kb-surface-raised/75 p-4 text-left shadow-[0_24px_70px_rgba(20,15,12,0.3)] backdrop-blur-2xl sm:mt-8 sm:p-5 lg:p-6">
            ...
            <div className="px-1 pb-1 pt-5 sm:px-0 sm:pt-6">
              <p className="font-inter text-sm font-normal text-kb-ink-soft sm:text-base">Not sure where to start? Try these…</p>
