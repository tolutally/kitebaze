    ...
    <section className="relative z-10 ml-auto mr-auto max-w-7xl overflow-visible border-b border-kb-line bg-kb-canvas pb-4 pl-6 pr-6 pt-0">
      <div className="flex mt-32 z-20 relative justify-center">
        <div className="flex relative items-center justify-center">
          <div className="absolute -top-32 h-32 w-[2px] bg-gradient-to-b from-transparent via-kb-accent/50 to-kb-accent shadow-[0_0_20px_rgba(159,107,78,0.65)] overflow-hidden">
            <div className="absolute inset-0 h-1/2 w-full animate-[scanner_2s_linear_infinite] bg-kb-inverse-text/60 blur-[2px]"></div>
          </div>
          <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-kb-accent/30 bg-kb-inverse shadow-[0_0_50px_rgba(159,107,78,0.32)]">
            <div className="absolute inset-[-10px] rounded-full border border-kb-accent/20 border-dashed animate-[spin_10s_linear_infinite]"></div>
            <div className="absolute inset-[-4px] rounded-full border border-kb-accent/30 border-dotted animate-[spin_15s_linear_infinite_reverse]"></div>
      ...
      <div className="text-center max-w-7xl mx-auto mb-20 px-4 sm:px-6 lg:px-8">
        <h2 className="md:text-6xl text-4xl font-medium text-kb-accent-ink font-space-grotesk mt-8" style={{ animation: 'slideInY 800ms ease-in-out 0ms forwards' }}>
        ...
        <div className="grid grid-cols-1 gap-y-8 gap-x-10 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
          <div className="flex flex-col gap-y-4 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="text-kb-accent">
